                    ...
                    <ul className=' flex flex-col gap-2'>
                        {books.map(book => (
                            <li key={book.id} className=' flex gap-2 mx-3 border-b-2 py-2'>
                                <Link className='w-[26%]' to={`bookdetails/${book.id}`}><img className=' w-full h-full' src={book.imageUrl} alt="" /></Link>
