            ...
            <tbody className="bg-white">
              {books.map(book => (
                <tr key={book?.id} className="text-gray-700 border">
                  ...
                  <td className="px-4 py-3 text-sm"><span className={`${book?.stock > 0 ? "bg-blue-200" : "bg-red-200"} px-2.5 py-2 font-semibold rounded-full`}>{book?.stock > 0 ? book?.stock : "Out of stock"}</span></td>
